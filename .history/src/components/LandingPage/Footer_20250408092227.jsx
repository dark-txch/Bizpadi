	...
	return (
		<div className="footer">
			...
			<section className="footerFeaturesParent">
				<div className="singleFeatureC items">
				...
				<div className="fsingleFeatureC clients">
					<div className="imageContainer">
				...
				<div className="fsingleFeatureC trackProfits">
					<div className="imageContainer">
						<img
				...
				<div className="fsingleFeatureC trackSales">
					<div className="imageContainer">
						<img
