...
export default function WelcomeSecond() {
  ...
  const handleFinish = async () => {
    ...
    localStorage.setItem("signup_step3", JSON.stringify({
      ...
      <div className="biz-form">
        ...
        <form className="form-frame">
          <div className="frame">
            ...
            <label htmlFor="estimatedRevenue">
              ...
              <div className="estimate">
                <select id="currency" value={form.currency} onChange={handleSelectChange}>
          ...
          <div className="biz-btns">
            ...
            <button type="button" className="biz-btn finish-btn" onClick={handleFinish}>
              Save and Finish
            </button>
          </div>
        </form>
